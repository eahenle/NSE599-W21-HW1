...
int n_bins_side, n_bins, n_proc, mpi_rank, n, n_rows_proc;
double mpi_size;
...
{
    vector<int> res;
    int row_s = mpi_rank * n_rows_proc, row_e = min(n_bins_side, n_rows_proc * (mpi_rank + 1));
